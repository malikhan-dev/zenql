...
- ** Thor Collections Api:** MaxAllocGuard default value set to 200000. contracts.SetMaxAllocGuard() default value.
  
- ** Thor Collections Api:** Introducing Take function for collections.
